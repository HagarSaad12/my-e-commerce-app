      ...
      <h3>My Wishlist</h3>
        ...
        <div className="row">
          <div className="col-md-11 p-5 shadow bg-main-light my-5">
            ...
            {data.map((ele)=>{
              return <div className="row py-5 border-bottom" key={ele._id}>
                ...
                <div className="col-md-10 d-flex justify-content-between align-items-center">
                   <div>
                    <h3>{ele.title}</h3>
                    <p>{ele.price} EGP</p>
                    <button onClick={()=>{removeMyWish(ele._id)}} className='btn btn-outline-danger'><i className='fa-regular fa-trash-can mx-2'></i>Remove</button>
                   </div>
                   <div>
                   <button onClick={()=>{addToMyCart(ele._id)}} className='btn btn-success text-light'>Add To Cart</button>
